...
using ko2ic.VSAutoBuild;

namespace VSAutoBuild_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSAutoBuildPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(ko2ic.VSAutoBuild.GuidList.guidVSAutoBuildCmdSet, (int)ko2ic.VSAutoBuild.PkgCmdIDList.cmdidAutoBuild);
