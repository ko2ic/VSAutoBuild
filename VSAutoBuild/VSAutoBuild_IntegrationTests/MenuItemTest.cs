...
namespace VSAutoBuild_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(ko2ic.VSAutoBuild.GuidList.guidVSAutoBuildCmdSet, (int)ko2ic.VSAutoBuild.PkgCmdIDList.cmdidAutoBuild);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSAutoBuild", "ko2ic.VSAutoBuild.VSAutoBuildPackage");
